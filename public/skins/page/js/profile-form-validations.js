document.addEventListener("DOMContentLoaded", function () {
  ...
  initCountryStateCity({
    countryId: "company_country",
    stateId: "company_state",
    cityId: "company_city",
    stateWrapperId: "company-state-wrapper",
    cityWrapperId: "company-city-wrapper",
    defaultCountry:selectedCountry2,
    defaultState:selectedState2,
    defaultCity:selectedCity2,    
  });
  ...
  const form = document.querySelector(".supplier-profile-form form");
  ...
  function isFormValid() {
    return true;
    /*
    return (validateCompanyName(false) && 
