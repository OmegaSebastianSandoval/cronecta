...
if (strpos($_SERVER['HTTP_HOST'], "xovis.omegasolucionesweb.com") !== false) {
  $env = "staging";
} else if (strpos($_SERVER['HTTP_HOST'], "pruebas2.cronecta.com") !== false) {
  $env = "production";
}
define('APPLICATION_ENV', getenv('APPLICATION_ENV') ? getenv('APPLICATION_ENV') : $env);

if (APPLICATION_ENV == "production") {
  define('RUTA_SUPPLIER', 'https://pruebas2.cronecta.com/supplier/');
  define('RUTA_BUYER', 'https://pruebas2.cronecta.com/page/');
