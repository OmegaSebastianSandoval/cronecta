			...
			<div class="row">
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->client_id; ?>" name="client_id" id="client_id" class="form-control"   >
					</label>
				...
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->code; ?>" name="code" id="code" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
