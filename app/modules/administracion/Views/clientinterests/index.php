        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="client_id" value="<?php echo $this->getObjectVariable($this->filters, 'client_id') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>code</label>
		            ...
		            <input type="text" class="form-control" name="code" value="<?php echo $this->getObjectVariable($this->filters, 'code') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>name</label>
