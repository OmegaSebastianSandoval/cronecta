...
<div class="container-fluid">
	<form action="<?php echo $this->route; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            <label>segment_code</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="segment_code" value="<?php echo $this->getObjectVariable($this->filters, 'segment_code') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>segment_name</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="segment_name" value="<?php echo $this->getObjectVariable($this->filters, 'segment_name') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="sector_id" value="<?php echo $this->getObjectVariable($this->filters, 'sector_id') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						<td><?=$content->segment_code;?></td>
						<td><?=$content->segment_name;?></td>
						<td><?=$content->created_at;?></td>
						<td><?=$content->updated_at;?></td>
						<td><?=$content->sector_id;?></td>
						<td class="text-end">
							<div>
