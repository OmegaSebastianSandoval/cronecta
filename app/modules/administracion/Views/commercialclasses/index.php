        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="class_code" value="<?php echo $this->getObjectVariable($this->filters, 'class_code') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="class_name" value="<?php echo $this->getObjectVariable($this->filters, 'class_name') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
