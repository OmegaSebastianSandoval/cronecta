        ...
        <div class="col-2 form-group">
          ...
          <label class="input-group">
            ...
            <input readonly type="text" value="<?php if ($this->content->publicidad_fecha) {
                                                                ...
                                                                echo date('Y-m-d');
                                                            } ?>" name="publicidad_fecha" id="publicidad_fecha"
              class="form-control" data-provide="" data-date-format="yyyy-mm-dd" data-date-language="es">
          </label>
          <div class="help-block with-errors"></div>
        </div>
        ...
        <div class="col-3 form-group">
          ...
          <div id="imagen_publicidad_imagen">
            ...
            <div><button class="btn btn-danger btn-sm" type="button"
                onclick="eliminarImagen('publicidad_imagen','<?php echo $this->route . "/deleteimage";
                                                                                                                                        ?>')"><i
        ...
        <div class="col-3 form-group">
          ...
          <div id="imagen_publicidad_imagenresponsive">
            <img src="/images/<?= $this->content->publicidad_imagenresponsive; ?>"
              class="img-thumbnail thumbnail-administrator" />
            <div><button class="btn btn-danger btn-sm" type="button"
                onclick="eliminarImagen('publicidad_imagenresponsive','<?php echo $this->route . "/deleteimage";
                                                                                                                                                ?>')"><i
                  class="glyphicon glyphicon-remove"></i> Eliminar Imagen</button></div>
          </div>
          <?php } ?>
          ...
          <label class="input-group">
            ...
            <select class="form-control" name="publicidad_tipo_enlace">
              ...
              <?php foreach ($this->list_publicidad_tipo_enlace as $key => $value) { ?>
                <option <?php if ( $this->getObjectVariable($this->content, "publicidad_tipo_enlace") == $key ) { echo "selected"; } ?> value=" <?php echo $key; ?>" />
                  <?= $value; ?>
                </option>
              <?php } ?>
            </select>
