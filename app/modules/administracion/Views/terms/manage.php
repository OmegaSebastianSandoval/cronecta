			...
			<div class="row">
				<div class="col-12 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->title; ?>" name="title" id="title" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
					<label for="content" class="form-label" >content</label>
					<textarea name="content" id="content"   class="form-control tinyeditor" rows="10"   ><?= $this->content->content; ?></textarea>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 form-group">
