        ...
        <div class="content-dashboard">
            <div class="row">
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="supplier_id">
	                        ...
	                        <?php foreach ($this->list_supplier_id as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'supplier_id') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="type">
	                        ...
	                        <?php foreach ($this->list_type as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'type') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="start_date" value="<?php echo $this->getObjectVariable($this->filters, 'start_date') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="end_date" value="<?php echo $this->getObjectVariable($this->filters, 'end_date') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>certification_file</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="certification_file" value="<?php echo $this->getObjectVariable($this->filters, 'certification_file') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						<td><?= $this->list_supplier_id[$content->supplier_id];?>
						<td><?= $this->list_type[$content->type];?>
						<td><?=$content->start_date;?></td>
						<td><?=$content->end_date;?></td>
						<td><?=$content->certification_file;?></td>
						<td class="text-end">
							<div>
