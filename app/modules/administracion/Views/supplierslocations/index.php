	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="country">
	                        ...
	                        <?php foreach ($this->list_country as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'country') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="state">
	                        ...
	                        <?php foreach ($this->list_state as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'state') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="city">
	                        ...
	                        <?php foreach ($this->list_city as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'city') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						<td><?=$content->name;?></td>
						<td><?= $this->list_country[$content->country];?>
						<td><?= $this->list_state[$content->state];?>
						<td><?= $this->list_city[$content->city];?>
