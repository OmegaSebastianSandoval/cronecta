	                ...
	                <label class="input-group">
	                    ...
	                    <select class="form-control" name="segment_id">
	                        ...
	                        <?php foreach ($this->list_segment_id as $key => $value) : ?>
	                            <option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'segment_id') ==  $key) { echo "selected";} ?>><?= $value; ?></option>
	                        <?php endforeach ?>
	                    </select>
	               </label>
	            </div>
			...
			<tbody>
				...
				<?php $id =  $content->id; ?>
					<tr>
						...
						<td><?= $this->list_segment_id[$content->segment_id];?>
						<td class="text-end">
							<div>
