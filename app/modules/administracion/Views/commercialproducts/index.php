        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="product_code" value="<?php echo $this->getObjectVariable($this->filters, 'product_code') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="product_name" value="<?php echo $this->getObjectVariable($this->filters, 'product_name') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
