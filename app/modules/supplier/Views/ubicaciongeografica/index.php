...
$("#buscador").select2({ placeholder: "Buscar", minimumInputLength:4,


  ajax: {
    url: function (params) {
      return '/supplier/ubicaciongeografica/search/?q='+params.term;
    },
    /*
...
function cargar_paises(region){
  $('.regiones').hide();
  $('.paises').show();
  $.post("/supplier/ubicaciongeografica/get_paises/",{"region":region },function(res){
...
function get_estados(pais){
  ...
  $('.paises').hide();
  $('.estados').show();
  $.post("/supplier/ubicaciongeografica/get_estados/",{"pais":pais },function(res){
...
function get_ciudades(estado,pais){
  ...
  $('.estados').hide();
  $('.ciudades').show();
  $.post("/supplier/ubicaciongeografica/get_ciudades/",{"estado":estado,"pais":pais },function(res){
...
function cobertura_global(){
  ...
  $.post("/supplier/ubicaciongeografica/worldwide/",{"valor":valor },function(res){
    //$("#saved").show();
    if(valor==1){
...
function agregaritem(){
  ...
  $.post("/supplier/ubicaciongeografica/agregar_ubicacion/",{"valor":valor },function(res){
...
function remove_geolocation(id){
  $.post("/supplier/ubicaciongeografica/borrar_ubicacion/",{"id":id},function(res){
