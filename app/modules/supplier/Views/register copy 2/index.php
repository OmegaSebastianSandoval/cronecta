    ...
    <form class="text-left" enctype="multipart/form-data" method="post" action="<?php echo $this->routeform; ?>" data-bs-toggle="validator">
      <div class="content-dashboard">
        ...
        <div class="row">
          ...
          <div class="col-6 col-md-9 col-lg-9">
            <div class="row">
              ...
              <div class="col-6 col-md-3 col-lg-3 form-group">
                <label for="is_legal_entity" class="control-label">Tipo de Persona</label>
              ...
              <div class="col-6 col-md-3 col-lg-3 form-group">
                <label for="supplier_type" class="control-label">Tipo de sociedad <span>*</span></label>
                <label class="input-group">
              ...
              <div class="col-6 col-md-3 col-lg-3 form-group">
                <label for="company_type" class="control-label">Tipo de sociedad <span>*</span></label>
                <label class="input-group">
              ...
              <div class="col-6 col-md-3 col-lg-3 form-group">
               ...
               <div class="col-6 col-md-3 col-lg-3 form-group">
                <label for="state" class="control-label">Departamento/Estado <span>*</span></label>
                <label class="input-group">
        ...
        <div class="row d-none">
          ...
          <div class="col-12 form-group">
            <label for="commercial_activity" class="control-label">Descripci&oacute;n de la actividad comercial</label>
            <label class="input-group">
          ...
          <div class="col-12 form-group">
            <label class="control-label">Nacionalidad NIT / Tax Id</label>
            <label class="input-group">
              ...
              <select class="form-control" name="nationality">
                ...
                <?php foreach ($this->list_nationality as $key => $value) { ?>
                  <option <?php if ($this->getObjectVariable($this->content, "nationality") == $key) {
                            echo "selected";
            ...
            <label class="input-group">
              ...
              <select class="form-control" name="industry">
                ...
                <?php foreach ($this->list_industry as $key => $value) { ?>
                  <option <?php if ($this->getObjectVariable($this->content, "industry") == $key) {
                            echo "selected";
                          } ?> value="<?php echo $key; ?>" /> <?= $value; ?></option>
                <?php } ?>
              </select>
