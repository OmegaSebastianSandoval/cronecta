  ...
  <div class="col-md-12 mt-5">
    ...
    <div class="caja_gris">
      <?php foreach ($this->selectedSectors as $interest) { ?>
        ...
        <?php $array_selected_sectors[]=$interest->name; ?>
      <?php } ?>
    </div>
  ...
  <div class="col-md-12">
    ...
    <div class="caja_gris">
      <?php foreach ($this->selectedSegment as $interest) { ?>
        ...
        <?php $array_selected_segments[]=$interest->name; ?>
      <?php } ?>
    </div>
  </div>
  ...
  <div class="col-md-12">
    ...
    <div class="caja_gris">
      <?php foreach ($this->selectedFamily as $interest) { ?>
        ...
        <?php $array_selected_family[]=$interest->name; ?>
      <?php } ?>
    </div>
  ...
  <div class="col-md-12">
    ...
    <div class="caja_gris">
      <?php foreach ($this->selectedClass as $interest) { ?>
        ...
        <?php $array_selected_class[]=$interest->name; ?>
      <?php } ?>
    </div>
  ...
  <div class="col-md-12">
    ...
    <div class="caja_gris">
      <?php foreach ($this->selectedProduct as $interest) { ?>
        ...
        <?php $array_selected_product[]=$interest->name; ?>
      <?php } ?>
    </div>
          ...
          <div class="row mt-2">
            <?php foreach ($this->sectors as $key => $sector) { ?>
              <div class="col-lg-4 mb-4">
                <label><input class="form-check-input" type="checkbox" id="sector<?php echo $key; ?>" value="<?php echo $sector->id; ?>_<?php echo $sector->name; ?>" <?php if(in_array($sector->name,(array)$array_selected_sectors)){ echo 'checked'; }?> > <?php echo $sector->name; ?></label>
              </div>
            <?php } ?>
          </div>
          ...
          <div class="row mt-2" id="seccion_segmento">
            ...
            <?php foreach ($this->segments_filtro as $key => $segment) { ?>
              <div class="col-lg-6 mb-4">
                <label><input class="form-check-input" type="checkbox" id="segment<?php echo $key; ?>" value="<?php echo $segment->segment_code; ?>_<?php echo $segment->segment_name; ?>" <?php if(in_array($segment->segment_name,(array)$array_selected_segments)){ echo 'checked'; }?> > <?php echo $segment->segment_name; ?></label>
              </div>
            <?php } ?>
          </div>
        ...
        <div class="caja_gris">
          ...
          <div class="row mt-2" id="seccion_familia">
            ...
            <?php foreach ($this->family_filtro as $key => $family) { ?>
              <div class="col-lg-6 mb-4">
                <label><input class="form-check-input" type="checkbox" id="family<?php echo $key; ?>" value="<?php echo $family->family_code; ?>_<?php echo $family->family_name; ?>" <?php if(in_array($family->family_name,(array)$array_selected_family)){ echo 'checked'; }?> > <?php echo $family->family_name; ?></label>
              </div>
            <?php } ?>
        ...
        <div class="caja_gris">
          ...
          <div class="row mt-2" id="seccion_clase">
            ...
            <?php foreach ($this->class_filtro as $key => $class1) { ?>
              <div class="col-lg-6 mb-4">
                <label><input class="form-check-input" type="checkbox" id="class<?php echo $key; ?>" value="<?php echo $class1->class_code; ?>_<?php echo $class1->class_name; ?>" <?php if(in_array($class1->class_name,(array)$array_selected_class)){ echo 'checked'; }?> > <?php echo $class1->class_name; ?></label>
              </div>
            <?php } ?>
          </div>
        ...
        <div class="caja_gris">
          ...
          <div class="row mt-2" id="seccion_producto">
            ...
            <?php foreach ($this->product_filtro as $key => $product) { ?>
              <div class="col-lg-6 mb-4">
                <label><input class="form-check-input" type="checkbox" id="product<?php echo $key; ?>" value="<?php echo $product->product_code; ?>_<?php echo $product->product_name; ?>" <?php if(in_array($product->product_name,(array)$array_selected_product)){ echo 'checked'; }?> > <?php echo $product->product_name; ?></label>
              </div>
            <?php } ?>
