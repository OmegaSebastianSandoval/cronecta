      ...
      <div class="col-12">
        <div class="d-flex justify-content-center">
          <div class="col-md-6">
            ...
            <form action="/page/profile/additem" method="post">
...
<script type="text/javascript">
  function add_sector(){
    ...
    $.post("/page/profile/addinterest/",{"valores":sectores, "nivel":1, "client_id":'<?php echo $_SESSION['client']->id; ?>' },function(res){
      window.location="/page/profile/?tab=2";
    });
  ...
  function add_segment(){
    ...
    $.post("/page/profile/addinterest/",{"valores":segmentos, "nivel":2, "client_id":'<?php echo $_SESSION['client']->id; ?>' },function(res){
      window.location="/page/profile/?tab=2";
    });
  ...
  function add_family(){
    ...
    $.post("/page/profile/addinterest/",{"valores":familias, "nivel":3, "client_id":'<?php echo $_SESSION['client']->id; ?>' },function(res){
      window.location="/page/profile/?tab=2";
    });
  ...
  function add_class(){
    ...
    $.post("/page/profile/addinterest/",{"valores":clases, "nivel":4, "client_id":'<?php echo $_SESSION['client']->id; ?>' },function(res){
      window.location="/page/profile/?tab=2";
    });
  ...
  function add_product(){
    ...
    $.post("/page/profile/addinterest/",{"valores":productos, "nivel":5, "client_id":'<?php echo $_SESSION['client']->id; ?>' },function(res){
      window.location="/page/profile/?tab=2";
    });
  ...
  function removeInterest(id){
    $.post("/page/profile/removeinterest/",{"id":id},function(res){
