        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="document" value="<?php echo $this->getObjectVariable($this->filters, 'document') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>level</label>
		            ...
		            <input type="text" class="form-control" name="level" value="<?php echo $this->getObjectVariable($this->filters, 'level') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>status</label>
		            ...
		            <input type="text" class="form-control" name="status" value="<?php echo $this->getObjectVariable($this->filters, 'status') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="remember_token" value="<?php echo $this->getObjectVariable($this->filters, 'remember_token') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
