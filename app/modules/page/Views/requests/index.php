...
<div class="container-fluid py-0 ">
  ...
  <div>
    <!-- Filtros -->
    <div class="filters flex-wrap d-flex mb-3">
      <div class="col-md-2 col-6 px-2">
        <label for="filter-category" class="">Ver por</label>
      ...
      <div class="col-md-2 col-6 px-2">
        <label for="filter-complexity" class="">Complejidad del proceso</label>
        <select id="filter-complexity" class="form-control rounded-0">
      ...
      <div class="col-md-2 col-6 px-2">
        <label for="filter-area" class="">Área requisitora</label>
        <input type="text" id="filter-area" class="form-control">
      </div>
      <div class="col-md-2 col-6 px-2">
        <label for="filter-user" class="">Usuario requisitor</label>
        <input type="text" id="filter-user" class="form-control">
      </div>
      <div class="col-md-2 col-6 px-2">
        <label for="filter-date" class="">Fecha</label>
        <input type="date" id="filter-date" class="form-control">
      </div>
      <div class="col-md-2 col-6 px-2">
        <label for="filter-state" class="">Estado</label>
      ...
      <div class="col-md-2 col-6 px-2">
        <label for="filter-type" class="">Tipo de solicitud</label>
      ...
      <div class="col-md-2 col-6 d-flex align-items-end px-2">
    ...
    <div class="table-bx">
      <table class="table table-striped sales-opportunities display">
        <thead>

          <tr>

            <th data-priority="1">#</th>
            <th data-priority="2">REQUERIMIENTO</th>
            <th data-priority="3">CANTIDAD</th>
            <th data-priority="4">UNIDAD DE MEDIDA</th>
            <th data-priority="5">LUGAR DE ENTREGA</th>
            <th data-priority="6">COMPLEJIDAD DE COMPRA</th>
            <th data-priority="7">CATEGORÍA</th>
            <th data-priority="8">SEGMENTO</th>
            <th data-priority="9">PRESUPUESTO</th>
            <th data-priority="10">USUARIO REQUISITOR</th>
            <th data-priority="11">AREA REQUISITORA</th>
            <th data-priority="12">
              <span>
                MES<i class="fa-regular fa-circle-question ms-1"></i>
              </span>
            </th>
            <th data-priority="13">
              <span>
                AÑO<i class="fa-regular fa-circle-question ms-1"></i>
              </span>
            </th>
            <th data-priority="14">TIPO CONTRATACIÓN</th>
            <th data-priority="15">FECHA REAL DE APERTURA</th>
            <th data-priority="16">FECHA LIMITE DE RESPUESTA</th>
            <th data-priority="17">ESTADO</th>
            <th data-priority="18">CANTIDAD DE PROVEEDORES REQUERIDOS</th>
            <th data-priority="19">PROVEEDORES DISPONIBLES</th>
            <th data-priority="20">PROVEEDORES CONVOCADOS</th>
            <th data-priority="21">PROVEEDORES POSTULADOS</th>
            <th class="sticky-header" data-priority="100">ACCIONES</th>
          </tr>
    ...
    <div class="col-12">
      <div class="alert alert-warning py-2" role="alert">
        ¡Atención! Estas compras aun no han sido activadas, por favor revisalas y completa la información necesaria para que los proveedores puedan verlas.
              ...
              <div class="d-flex table-buttons-container">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu custom-dropdown-menu">
                    ...
                    <li>
                      <a class="dropdown-item" href="#" datd-bs-toggle="modal" data-bs-target="#editModal">
                        <i class="fa-solid fa-edit me-2"></i>Editar
                      </a>
                    </li>
                    <li>
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    let table = new DataTable('.sales-opportunities', {
      // responsive: true,
