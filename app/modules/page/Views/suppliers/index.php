                                ...
                                <div class="row">
                                  ...
                                  <div class="col-12">
                                    <p class="cv-contact-row">
                                      <i class="fa-regular fa-user"></i> <?php echo  $supplier->user->name." ".$supplier->user->lastname ?>
                                    </p>
                                    <p class="cv-contact-row">
                                      <i class="fa-solid fa-sitemap"></i> <?php echo  $supplier->position ?>
                                    </p>
                                    <p class="cv-contact-row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-12">
                                <p class="cv-description">
                                  <b>Descripción:</b><br>
                                  <div class="cv-description"><?php echo  $supplier->commercial_activity ?></div>
                                </p>
                                ...
                                <p class="cv-description">
                                  ...
                                  <?php foreach($supplier->industries as $industry){ ?>
                                    <li><?php echo $this->list_industry[$industry]; ?></li>
                                  <?php }?>
                                  </ul>
                                </p>
                                <p class="cv-description">
                                  ...
                                  <?php foreach($supplier->segments as $segment){ ?>
                                    <li><?php echo $this->list_segments[$segment]; ?></li>
                                  <?php }?>
                                  </ul>                                  
                                </p>
                                ...
                                <p class="cv-description">
                                  <b>Fecha de constitución de la empresa:</b> <?php echo  formatoDMY($supplier->company_date); ?>
                                  </p>
                                <p class="cv-description">
                                  <b>Experiencia comercial:</b><br>
                                  <ul class="cv-description">
                                  <?php foreach($supplier->experience_list as $value){ ?>
                                    <li><?php echo $value->company_name ?> (<?php echo formatoDMY($value->contract_start_year); ?> - <?php echo formatoDMY($value->contract_end_year); if($supplier->contract_current=="1"){ echo "Actualmente vigente"; } ?>)</li>  
                                  <?php } ?>
                                  </ul>                                
                                ...
                                <p align="center">
                                  <button type="button" class="btn btn-sm btn-primary " @click="openModal(supplier.id)">Contactar Proveedor</button>
                                </p>
                              </div>
...
.supplier-card .card-bottom .card-buttons .btn-primary, .cv-modal .btn-primary {
  background-color: #23366c;
  color: #fff;
  padding: 10px 20px;
  border: none;
...
.cv-description, .cv-description p{
  font-size: 14px;
